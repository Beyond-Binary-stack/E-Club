const Community = () => {
  return (
    <section className="relative py-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      >
        {/* Overlay */}
        <div className="absolute inset-0 bg-linguavibe-teal/80"></div>
      </div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-8 sm:p-12 lg:p-16 shadow-2xl">
          <svg
            className="w-16 h-16 text-linguavibe-orange mx-auto mb-6"
            fill="currentColor"
            viewBox="0 0 24 24"
          >
          ...
          <blockquote className="text-2xl sm:text-3xl md:text-4xl font-bold text-linguavibe-text-primary leading-relaxed mb-4">
            At Linguavibe, your voice matters. Mistakes are welcome.
          </blockquote>
          <p className="text-lg sm:text-xl text-linguavibe-text-secondary mt-6">
